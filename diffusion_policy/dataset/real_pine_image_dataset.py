...
from diffusion_policy.real_world.pine_data_conversion import pine_data_to_replay_buffer
...
class RealPineImageDataset(BaseImageDataset):
    def __init__(self,
            shape_meta: dict,
            dataset_path: str,
            horizon=1,
...
def _get_replay_buffer(dataset_path, shape_meta, store):
    ...
    with threadpool_limits(1):
        replay_buffer = pine_data_to_replay_buffer(
            dataset_path=dataset_path,
            out_store=store,
